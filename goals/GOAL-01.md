...
- Object references, binding manifests, command receipts, audit events and content preference revisions are immutable.
- Fixture/replay/fault/FakeClock checks run against the same local persistence handler.
...
5. Add fixture/replay/fault/FakeClock verification for resume-safe evidence.
6. Record validation evidence in `GOAL-01_VALIDATION_REPORT.md`.
...
- The SQLite schema is accepted as the executable local proof for this stage; PostgreSQL runtime execution is deferred to the environment gate.
